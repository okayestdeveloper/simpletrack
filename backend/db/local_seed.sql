-- PGOPTIONS=--search_path=stdb psql -d simpletrack -f local_seed.sql -U stdb_user

insert into site
  (site_id, label, description, address)
values
...
insert into asset
  (asset_id, asset_type_id, asset_status_id, site_id, location_id, code)
values
  ...
  ('da4802b6-71a8-4168-8bb8-1839b92848ae', '66001018-8239-424e-8bdf-1f6bde813372', '733c41ca-53e9-441f-ad2f-7ff4227598dc', 'fcaf620c-67f2-4805-8c5e-dc980b92d44c', null, '0005'); -- customer

insert into asset_meta_type
  (asset_meta_type_id, label)
values
  ('15cc6781-1797-4c00-8951-7fc426c757c4', 'Beer');

insert into asset_meta
  (asset_meta_id, asset_meta_type_id, asset_id, label)
values
